...
covariate_labels <- c("Negative ESG Information",
                      ...
                      "Ethnicity, White",
                      "Ethnicity, Other",
                      "Investing Knowledge, 1-5 years",
                      "Investing Knowledge, 5-10 years",
                      "Investing Knowledge, 10+ years",
...
model_3 <- lm(as.numeric(
  stock) ~ assignment_to_treatment + 
    ...
    factor(investing_knowledge, levels=c("0-1 year", "1-5 years", "5-10 years", "10+ years")) +
    factor(education, levels=c("Associate", "High School", "Undergraduate", "Postgraduate")), data=d)

d$investing_knowledge
...
```{r model_summary_1, include=TRUE, results = "asis"}
...
stargazer(model, model_2, title="Impact of Negative ESG Information on the Likelihood to Invest in Stock",
dep.var.labels=c("Likelihood to Invest in Stock"),
covariate.labels=covariate_labels,
omit.stat=c("LL","ser","f"), single.row=TRUE)
```
